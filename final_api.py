...
api = Api(app, authorizations={
          ...
          description="Input properties of application you want to produce, and we predict the downloads for you.")# Documentation Description
...
@api.param('content', 'What is the least age requirement for this app? (from 0 to 18)', required = True)
...
class prediction(Resource):
    ...
    def get(self, category, genres):
        ...
        if content > 18 or content < 0 or int(content) != float(content):
            return {"message": "content '{}' is invalid".format(request.args.get('content'))}, 400
